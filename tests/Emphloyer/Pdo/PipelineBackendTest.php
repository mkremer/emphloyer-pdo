...
class PipelineBackendTest extends \Emphloyer\Pipeline\BackendTestCase
{
    public function setUp()
    {
        ...
        $this->backend = new PipelineBackend($GLOBALS['DB_DSN'], $GLOBALS['DB_USER'], $GLOBALS['DB_PASSWD'], array(),
            "test_jobs");
        parent::setUp();
    }
    ...
    {
        $backend = new PipelineBackend($GLOBALS['DB_DSN'], $GLOBALS['DB_USER'], $GLOBALS['DB_PASSWD'], array(),
            "override_jobs");
