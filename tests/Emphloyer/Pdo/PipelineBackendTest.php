...
class PipelineBackendTest extends \Emphloyer\Pipeline\BackendTestCase {
  public function setUp() {
    ...
    $this->pdo->exec('CREATE table emphloyer_jobs (uuid VARCHAR(36) PRIMARY KEY, created_at TIMESTAMP, run_from TIMESTAMP, locked_at TIMESTAMP, lock_uuid VARCHAR(36) UNIQUE, status VARCHAR(20), class_name VARCHAR(255), type VARCHAR(100), attributes TEXT);');
